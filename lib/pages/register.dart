...
Future<bool> register_user(String email, String password, String name, int age,
...
Widget Input_forms(Icon left_icon, String hidden_text, String validator_func,
    TextEditingController controller_data) {
  return Container(
    ...
    child: TextFormField(
      ...
      keyboardType:
          validator_func == "age" ? TextInputType.number : TextInputType.text,
      inputFormatters: validator_func == "age"
